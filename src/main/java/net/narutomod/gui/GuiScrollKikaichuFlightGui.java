...
public class GuiScrollKikaichuFlightGui extends ElementsNarutomodMod.ModElement {
	public static int GUIID = 55;

	public GuiScrollKikaichuFlightGui(ElementsNarutomodMod instance) {
		super(instance, 750);
	}
	...
	public static class GuiContainerMod extends GuiNinjaScroll.GuiContainerMod {
		...
		protected void handleButtonAction(EntityPlayer player, int buttonID) {
			...
			if (player.world.isRemote || !player.world.isBlockLoaded(new BlockPos(this.x, this.y, this.z)))
				return;
			ItemStack stack = GuiNinjaScroll.enableJutsu(player, (ItemNinjutsu.RangedItem)ItemNinjutsu.block, ItemNinjutsu.BUGFLIGHT, true);
			if (stack != null) {
	...
	public static class GuiWindow extends GuiNinjaScroll.GuiWindow {
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString(ItemNinjutsu.BUGFLIGHT.getName(), 38, 13, -16777216);
		}
	}
}
