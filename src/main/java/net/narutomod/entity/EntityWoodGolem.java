...
public class EntityWoodGolem extends ElementsNarutomodMod.ModElement {
	...
	public static class EC extends EntityShieldBase implements ItemJutsu.IJutsu {
		...
		public EC(EntityLivingBase summonerIn, double chakraUsagePerSec) {
			...
			this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(health*3+500);
			...
			if (!this.world.isRemote) {
				if (this.canTick && this.getSummoner() != null) {
					...
					if (stack != null && stack.getItem() instanceof ItemJutsu.Base) {
						...
						item.setJutsuCooldown(stack, GOLEM, 20 * 45);
					}
				}
			}
		}
		...
		public static class Jutsu implements ItemJutsu.IJutsuCallback {
			...
			public boolean createJutsu(ItemStack stack, EntityLivingBase entity, float power) {
				if (!entity.isRiding() || !(entity.getRidingEntity() instanceof EC)) {
					...
					ItemJutsu.setCurrentJutsuCooldown(stack, 700);
					return true;
				}
				return false;
			}
