...
public class EntityIrukaSensei extends ElementsNarutomodMod.ModElement {
	...
	public static class EntityCustom extends EntityNinjaMerchant.Base {
		...
		public Map<EntityNinjaMerchant.TradeLevel, MerchantRecipeList> getTrades() {
			...
			commonTrades.add(new MerchantRecipe(new ItemStack(Items.EMERALD, 1), ItemStack.EMPTY, new ItemStack(ItemScrollKageBunshin.block, 1), 0, 1));
			commonTrades.add(new MerchantRecipe(new ItemStack(Items.EMERALD, 1), ItemStack.EMPTY, new ItemStack(ItemScrollEarthSpears.block, 1), 0, 1));
			commonTrades.add(new MerchantRecipe(new ItemStack(Items.EMERALD, 1), ItemStack.EMPTY, new ItemStack(ItemScrollWaterCannon.block, 1), 0, 1));
			commonTrades.add(new MerchantRecipe(new ItemStack(Items.EMERALD, 1), ItemStack.EMPTY, new ItemStack(ItemScrollGreatFireball.block, 1), 0, 1));
			commonTrades.add(new MerchantRecipe(new ItemStack(Items.EMERALD, 1), ItemStack.EMPTY, new ItemStack(ItemScrollLightningBeast.block, 1), 0, 1));
			commonTrades.add(new MerchantRecipe(new ItemStack(Items.EMERALD, 1), ItemStack.EMPTY, new ItemStack(ItemScrollFutonVacuum.block, 1), 0, 1));
