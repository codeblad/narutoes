...
public class EntityToadSage extends ElementsNarutomodMod.ModElement {
    public static final int ENTITYID = 9003;
    public static final int ENTITYID_RANGED = 9004;
    public EntityToadSage(ElementsNarutomodMod instance) {
        super(instance, 9005);
    }
    ...
    public void initElements() {
        elements.entities
                .add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("narutomod", "toad_sage"), ENTITYID)
                        .name("toad_sage").tracker(64, 3, true).egg(-16777216, -10066330).build());
    }

    @Override
    public void init(FMLInitializationEvent event) {
        EntityRegistry.addSpawn(EntityTenten.EntityCustom.class, 5, 1, 1, EnumCreatureType.AMBIENT,
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new ModelBiped64(), 0.5f) {
                protected ResourceLocation getEntityTexture(Entity entity) {
                    return new ResourceLocation("narutomod:textures/toadsage.png");
                }
            };
        });
    }
        ...
        protected boolean processInteract(EntityPlayer player, EnumHand hand) {
            if (!this.world.isRemote && ProcedureUtils.getMatchingItemStack(player,ItemSenjutsu.block) == null) {
                ...
                if (giveItem) {
                    ...
                    stack.getTagCompound().setString("Type", "toad");
                    ...
                    stack2.getTagCompound().setString("Type", "toad");
                    this.setDead();
                }
            }
