	...
	public static class EC extends Entity implements ItemJutsu.IJutsu {
		...
		public void onUpdate() {
			if (this.user != null) {
				...
				if (ProcedureUtils.getMatchingItemStack(this.user, ItemIryoJutsu.block) == null) {
					this.setDead();
					return;
				}
				if (this.ticksExisted % 10 == 2 && (stack.isEmpty() || stack.getItem() == ItemIryoJutsu.block)) {
					this.user.addPotionEffect(new PotionEffect(PotionChakraEnhancedStrength.potion, 12, (int) (15+ItemJutsu.getDmgMult(this.user)*2.85f), true, false));
				}
