		...
		protected void onImpact(RayTraceResult result) {
			...
			if (!this.world.isRemote) {
				...
				ProcedureAoeCommand.set(this.world, vec.x, vec.y, vec.z, 0.0D, 24.0D).exclude(this).exclude(this.shootingEntity)
				 .setFire(15).damageEntities(ItemJutsu.causeJutsuDamage(this, this.shootingEntity), (24f*ItemJutsu.getDmgMult(this.shootingEntity)+60));
			}
			//this.haltMotion();
			this.setDead();
		}
