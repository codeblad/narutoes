...
public class EntitySlugSage extends ElementsNarutomodMod.ModElement {
    public static final int ENTITYID = 9001;
    public static final int ENTITYID_RANGED = 9002;
    public EntitySlugSage(ElementsNarutomodMod instance) {
        super(instance, 9003);
    }
    ...
    public void initElements() {
        elements.entities
                .add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("narutomod", "slug_sage"), ENTITYID)
                        .name("slug_sage").tracker(64, 3, true).egg(-16777216, -10066330).build());
    }
    ...
    public static class EntityCustom extends EntityMob {
        ...
        protected boolean processInteract(EntityPlayer player, EnumHand hand) {
            if (PlayerTracker.getBattleXp(player) >= 10000 && ProcedureUtils.getMatchingItemStack(player,ItemSenjutsu.block) == null) {
                ...
                stack.getTagCompound().setString("Type", "slug");
                ...
                stack2.getTagCompound().setString("Type", "slug");
            }
