...
public abstract class EntityBijuManager<T extends EntityTailedBeast.Base> {
	...
	public static final Map<Integer, EntityBijuManager> mapByTailnum = Maps.newHashMap();
	...
	public static EntityBijuManager getBijuByTail(int tail) {
	...
	public int increaseCloakLevel() {
		...
		if (this.cloakLevel == 3 && this.jinchurikiPlayer != null && (PlayerTracker.getBattleXp(this.jinchurikiPlayer) >= 10000)) {
			...
			if (biju != null) {
				biju.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue(75+3*ItemJutsu.getNinjaMult(this.jinchurikiPlayer));
				biju.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(800+67* ItemJutsu.getNinjaMult(this.jinchurikiPlayer));
				biju.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(0.75);
