	...
	public static class EntityCustom extends EntitySusanooBase {
		...
		public EntityCustom(EntityLivingBase entity, boolean fullBody) {
			...
			if (!(entity instanceof EntityPlayer)) {
				...
				if (this.hasLegs()) {
					this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(health*2.5+375);
					this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE)
							.setBaseValue(40.0D+ItemJutsu.getNinjaMult(entity)*4);
				} else {
					this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(health*2.25+225);
					this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE)
