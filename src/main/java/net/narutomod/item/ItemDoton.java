...
public class ItemDoton extends ElementsNarutomodMod.ModElement {
	...
	public static final ItemJutsu.JutsuEnum SPEARS = new ItemJutsu.JutsuEnum(4, "earth_spears", 'C', 15d, new EntityEarthSpears.EC.Jutsu());
	public static final ItemJutsu.JutsuEnum GOLEM = new ItemJutsu.JutsuEnum(5, "earth_golem", 'B', 200d, new EntityEarthGolem.EC.Jutsu());
