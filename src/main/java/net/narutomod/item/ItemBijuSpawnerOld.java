...
public class ItemBijuSpawnerOld extends ElementsNarutomodMod.ModElement {
	@GameRegistry.ObjectHolder("narutomod:bijuspawnerold")
	public static final Item block = null;
	public static final int ENTITYID = 11355;

	public ItemBijuSpawnerOld(ElementsNarutomodMod instance) {
	...
	public void initElements() {
		...
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class)
				.id(new ResourceLocation("narutomod", "bijuspawnerold"), ENTITYID).name("bijuspawnerold").tracker(64, 1, true).build());
	}
	...
	public static class RangedItem extends Item implements ItemOnBody.Interface {
		public RangedItem() {
			...
			setMaxDamage(0);
			setFull3D();
			setUnlocalizedName("bijuspawnerold");
			setRegistryName("bijuspawnerold");
			maxStackSize = 1;
