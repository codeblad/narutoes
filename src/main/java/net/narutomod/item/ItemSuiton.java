...
public class ItemSuiton extends ElementsNarutomodMod.ModElement {
	...
	public static final ItemJutsu.JutsuEnum WATERDRAGON = new ItemJutsu.JutsuEnum(2, "water_dragon", 'B', 160d, new EntityWaterDragon.EC.Jutsu());
	...
	public static final ItemJutsu.JutsuEnum WATERSHARK = new ItemJutsu.JutsuEnum(4, "suiton_shark", 'B', 175d, new EntitySuitonShark.EC.Jutsu());
	...
	public static final ItemJutsu.JutsuEnum WATERBOMB = new ItemJutsu.JutsuEnum(6, "water_canonball", 'C', 60d, new EntityWaterCanonball.EC.Jutsu());
