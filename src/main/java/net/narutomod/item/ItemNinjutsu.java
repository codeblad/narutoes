	...
	public class ItemNinjutsu extends ElementsNarutomodMod.ModElement {
		...
		public static final ItemJutsu.JutsuEnum BUGFLIGHT = new ItemJutsu.JutsuEnum(12, "bug_levitation", 'B', 0.5d, new EntityBugLevitation.EC.Jutsu());
		...
		public void initElements() {
			elements.items.add(() -> new RangedItem(REPLACEMENT, KAGEBUNSHIN, RASENGAN, LIMBOCLONE, AMENOTEJIKARA, PUPPET, BUGSWARM, INVISABILITY, TRANSFORM, HIRAISHIN, SHIKIGAMI, MULTICLONE, BUGFLIGHT));
