...
import net.narutomod.item.ItemClothesHokage.ModelRobeHokage;
...
public class ItemClothesEikage extends ElementsNarutomodMod.ModElement {
	@GameRegistry.ObjectHolder("narutomod:clothes_eikagehelmet")
	public static final Item helmet = null;
	@GameRegistry.ObjectHolder("narutomod:clothes_eikagebody")
	...
	public void initElements() {
		elements.items.add(() -> new ItemRobe.Base(EntityEquipmentSlot.HEAD) {
			...
			class Armor4Slot extends ItemNinjaArmor.ArmorData {
				...
				protected void init() {
					...
					this.model = model1;
					this.texture = "narutomod:textures/robe_eikage.png";
				}
			}
		}.setUnlocalizedName("clothes_eikagehelmet").setRegistryName("clothes_eikagehelmet").setCreativeTab(TabModTab.tab));
		...
		}.setUnlocalizedName("clothes_eikagebody").setRegistryName("clothes_eikagebody").setCreativeTab(TabModTab.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(helmet, 0, new ModelResourceLocation("narutomod:clothes_eikagehelmet", "inventory"));
		ModelLoader.setCustomModelResourceLocation(body, 0, new ModelResourceLocation("narutomod:clothes_eikagebody", "inventory"));
	}
	// Made with Blockbench 4.5.2
	// Exported for Minecraft version 1.7 - 1.12
	// Paste this class into your mod and generate all required imports
	public static class ModelRobeEikage extends ItemRobe.ModelRobe {
