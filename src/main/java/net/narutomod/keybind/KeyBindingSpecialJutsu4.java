...
import net.narutomod.procedure.ProcedureSpecialJutsu4OnKeyPressed;
...
public class KeyBindingSpecialJutsu4 extends ElementsNarutomodMod.ModElement {
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.specialjutsu4", Keyboard.KEY_V, "key.mcreator.category");
	...
	private static void pressAction(EntityPlayer entity, boolean is_pressed) {
			...
			return;
		{
			...
			ProcedureSpecialJutsu4OnKeyPressed.executeProcedure($_dependencies);
		}
	}
}
